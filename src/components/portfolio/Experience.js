...
export default function Experience() {
  ...
  return (
    <div className=" flex flex-col pt-80 sm:pr-20 md:pr-40 lg:pr-60 xl:pr-48 sm:pl-20 md:pl-20 lg:pl-40 xl:pl-48 hero-text">
      ...
      <motion.div className="flex pl-20 pt-8 flex-col justify-center hero-text2" style={{ opacity: experienceOpacity, scale: experienceScale }}>
        <div>
          <h1 className=" text-[1.5rem] leading-[3rem]">First Experience</h1>
          <h1 className=" text-[0.75rem] hero-text">First Experience</h1>
        </div>
