...
export default function HeroSection() {
  return (
    <div className="flex flex-col 2xl:flex-row ml-8 mr-8 sm:ml-20 sm:mr-20 md:ml-40 md:mr-40 lg:ml-60 lg:mr-60 xl:ml-96 xl:mr-96 2xl:ml-60">
      ...
      <div className="flex-1 z-10 p-10 pt-5 1xl:p-24 1xl:pt-5 2xl:p-0 xl2:pl-5">
        <motion.img
