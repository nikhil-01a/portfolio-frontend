...
export default function About() {
  ...
  const opacity = useTransform(scrollY, [1000, 1100, 1200, 1450], [0, 1, 1, 0])
  const textOpacity = useTransform(scrollY, [1000, 1100, 1200, 1450], [0, 1, 1, 0])
  const tagLineOpacity = useTransform(scrollY, [1450, 1550, 1650, 1850], [0, 1, 1, 0])
